...
class Coach:
    def __init__(self, trainset, devset, testset, model, opt, sched, args):
        ...
        params = {
            ...
            "transfomer_att_heads": args.gnn_nheads,
            "rnn":args.rnn,
            "gcn_conv": args.gcn_conv,
            "gat_att_heads": None if args.gcn_conv == "rgcn" else args.gat_heads,
            "window_past": args.wp,
            "window_future": args.wf,
            "epochs": args.epochs,
        ...
        if args.log_in_comet and not args.tuning:
            experiment = Experiment(
                ...
                project_name="cogmenbased",
                workspace=args.comet_workspace,
                auto_param_logging=False,
                auto_metric_logging=False,
            )
            self.experiment = experiment
            self.experiment.add_tag(args.tag)
    ...
    def evaluate(self, test=False):
        ...
        with torch.no_grad():
            ...
            if self.args.dataset == "mosei" and self.args.emotion == "multilabel":
                ...
                if self.args.log_in_comet:
                    self.experiment.log_metric("dev_acc", acc)
            else:
