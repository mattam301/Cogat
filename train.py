...
def main(args):
    ...
    if args.emotion:
        ...
        if args.transformers:
            ...
            print(os.path.join(args.data_root, args.data_dir_path, args.dataset, "transformers"))
        else:
            args.data = os.path.join(
    ...
    model = cogmen.Net(args).to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="mmgat",
        # required=True,
        choices=["rgcn", "gat", "rgat", "gatv2","mmgat"],
    ...
    parser.add_argument(
        "--fusion_method",
        default="joint",
        choices=("joint", "late", "early"),
        help="Choose modalities fusion type"
    )

    parser.add_argument(
        "--edge_type",
        default="intra_inter",
        choices=("intra_inter", "inter", "intra"),
